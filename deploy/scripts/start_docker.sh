...
aws ecr get-login-password --region ap-south-1 | docker login --username AWS --password-stdin 586794443089.dkr.ecr.us-east-1.amazonaws.com/music_recommend_system
